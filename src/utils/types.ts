...
export interface SuretyFormType
  ...
  export type NominationType = {
    ...
    isMinor: string | null;
    dobMinor: string | null;
    dateMajority: string | null;
    gurdianName: string | null;
    gurdianAddress: string | null;
    isDeceased: string | null;
    deceasedName: string | null;
    dobDeceased: string | null;
    deceasedFatherName: string | null;
    deceasedOccupation: string | null;
    deceasedNationality: string | null;
    deceasedEmail: string | null;
    deceasedRelationship: string | null;
    deceasedRelationshipMinor: string | null;
    projectID: number;
    createdAt: Date;
  };
