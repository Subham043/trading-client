...
const FolioeDrawer:FC<FoliosListDrawerProps & {toggleDrawer: (value: FoliosListDrawerProps) => void}> = (props) => {
    return (<Drawer opened={props.drawerStatus} onClose={() => props.toggleDrawer({drawerStatus: false})} position="right" title="Folio" overlayProps={{ backgroundOpacity: 0.5, blur: 4 }}>
        <FolioeDetail {...props} />
    </Drawer>)
}
