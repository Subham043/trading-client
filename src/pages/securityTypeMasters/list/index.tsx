    ...
    return (
        <div>
            ...
            <Text c="dimmed" ta="center">
                This page contains the list of all the security type masters. You can create a new security type masters by clicking the "Create" button. You can also export the list of security type masters to an excel file by clicking the "Export" button. You can also import a list of security type masters from an excel file by clicking the "Import" button. You can also delete a security type masters by clicking the "Delete" button.
            </Text>
